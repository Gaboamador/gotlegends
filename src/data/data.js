const items = {
    ...
    props: [
      { name: "Ability Cooldown Reduction", value: "5%-12%", description: "Reduces base cooldown of your class ability", gear: "All Katanas, All Charms" },
      ...
      { name: "Blast Radius", value: "15%-25%", description: "Increases the size of the blast radius of bombs", gear: "Bomb Pack, Forbidden Medicine, Sticky Bomb, Magma Bomb, The Touch of Heaven" },
      { name: "Cooldown Reduction on Kill", value: "1s-4s", description: "Any kill reduces the cooldown of this weapon", gear: "Kunai, Spirit Kunai, Sticky Bomb, Magma Bomb, The Touch of Heaven, Dirt Throw, Lady Sanjo's Surprise, Healing Gourd, Bottle of Liquid Courage, Kenji's Shared Brew, Caltrops, Demon Seeds, Smoke Bomb, The Mist of Yagata" },
      { name: "Cooldown Reduction", value: "8%-15%", description: "Reduces base cooldown of this weapon", gear: "Kunai, Spirit Kunai, Sticky Bomb, Magma Bomb, The Touch of Heaven, Dirt Throw, Lady Sanjo's Surprise, Healing Gourd, Bottle of Liquid Courage, Kenji's Shared Brew, Caltrops, Demon Seeds, Smoke Bomb, The Mist of Yagata" },
      ...
      { name: "Counter Damage", value: "10%-20%", description: "Increased damage on Perfect Parry and Perfect Dodge counter attacks", gear: "All Katanas, Melee Charm, Samurai Charm" },
      { name: "Damage Reduction", value: "5%-10%", description: "Reduces damage received from all sources.", gear: "Defense Charm, Healing Gourd, Bottle of Liquid Courage, Kenji's Shared Brew" },
      { name: "Draw Speed", value: "10%-20%", description: "Increases speed of drawing the bow", gear: "Half Bow, Longbow, The Weightless Spirit, Sugaru's Sight, Skipping Stone Bow, Ranged Charm" },
      ...
      { name: "Ghost Offering Health", value: "10%-25%", description: "Increases health restored when interacting with a Ghost Offering", gear: "Defense Charm, Healing Gourd, Bottle of Liquid Courage, Kenji's Shared Brew" },
      { name: "Ghost Weapon Damage", value: "12%-20%", description: "Increases damage of all Ghost Weapons", gear: "Stealth Charm, Assassin Charm, Kunai, Spirit Kunai, Sticky Bomb, Magma Bomb, The Touch of Heaven, Dirt Throw, Lady Sanjo's Surprise, Caltrops, Demon Seeds" },
      { name: "Headshot Damage", value: "5%-10%", description: "Increases damage od Headshots with the bow", gear: "Half Bow, Longbow, The Weightless Spirit, Sugaru's Sight, Skipping Stone Bow, Ranged Charm, Hunter Charm" },
      ...
      { name: "Injured Resolve Gain", value: "10%-25%", description: "Taking damage grants Resolve.", gear: "Defense Charm, Healing Gourd, Bottle of Liquid Courage, Kenji's Shared Brew" },
      { name: "Melee Damage", value: "5%-12%", description: "Increases damage from Melee attacks", gear: "All Katanas, Melee Charm, Samurai Charm, Kunai, Spirit Kunai" },
      { name: "Melee Resolve Gain", value: "5%-25%", description: "Increases Resolve gained from Melee attacks and kills", gear: "All Katanas, Melee Charm, Samurai Charm" },
      { name: "Melee Stagger Damage", value: "5%-12%", description: "Increases base Stagger damage against enemeies", gear: "All Katanas, Bomb Pack, Forbidden Medicine, Melee Charm, Samurai Charm, Caltrops, Demon Seeds" },
      { name: "Oni Damage", value: "5%-10%", description: "Increased damage against oni targets", gear: "All Katanas, All Charms" },
      { name: "Perfect Parry Window", value: "5%-12%", description: "Increases the length of time that an incoming attack can be parried", gear: "All Katanas, Melee Charm, Samurai Charm, Dirt Throw, Lady Sanjo's Surprise" },
      { name: "Ranged Damage", value: "5%-12%", description: "Increases damage from Ranged weapons.", gear: "Half Bow, Longbow, The Weightless Spirit, Sugaru's Sight, Skipping Stone Bow, Ranged Charm, Hunter Charm" },
      { name: "Ranged Projectile Velocity", value: "15%-25%", description: "Increases speed of projectiles", gear: "Half Bow, Longbow, The Weightless Spirit, Sugaru's Sight, Skipping Stone Bow" },
      { name: "Ranged Resolve Gain", value: "5%-10%", description: "Increases Resolve gained from Ranged attacks and kills.", gear: "Half Bow, Longbow, The Weightless Spirit, Sugaru's Sight, Skipping Stone Bow, Ranged Charm, Hunter Charm" },
      { name: "Reload Speed", value: "10%-20%", description: "Increases speed of nocking an arrow after firing", gear: "Half Bow, Longbow, The Weightless Spirit, Sugaru's Sight, Skipping Stone Bow, Ranged Charm, Hunter Charm" },
      ...
      { name: "Staggered Damage", value: "10%-20%", description: "Increased damage against Staggered targets", gear: "All Katanas, All Charms" },
      { name: "Status Effect Damage", value: "10%-18%", description: "Increases damage of Fire and Poison effects", gear: "Blowgun, Bomb Pack, Forbidden Medicine, Heaven's Sting, Stealth Charm" },
      { name: "Status Effect Duration", value: "10%-15%", description: "Increases duration of all status effects and stuns from abilities", gear: "Blowgun, Bomb Pack, Forbidden Medicine, Heaven's Sting, Stealth Charm, Assassin Charm, Kunai, Spirit Kunai, Sticky Bomb, Magma Bomb, The Touch of Heaven, Dirt Throw, Lady Sanjo's Surprise, Caltrops, Demon Seeds" },
      { name: "Stealth", value: "10%-20%", description: "While in stealth enemies take longer to detect you", gear: "Blowgun, Heaven's Sting, Stealth Charm, Assassin Charm, Smoke Bomb, The Mist of Yagata" },
      { name: "Stealth Attack Damage", value: "10%-25%", description: "Increases damage of stealth attacks", gear: "Blowgun, Heaven's Sting, Stealth Charm, Assassin Charm, Smoke Bomb, The Mist of Yagata" },
      { name: "Toxic Vanish Radius", value: "50%-100%", description: "Increases radius of Toxic Vanish", gear: "Assassin Charm" },
      { name: "Ultimate Damage", value: "10%-20%", description: "Increases base damage of the ultimate ability", gear: "All Katanas, All Charms" },
    ...
    perks: [
      { name: "Assassin Unlock", description: "Can be used by the Assassin", gear: "Bomb Pack, Forbidden Medicine" },
      { name: "Black Powder", description: "When the Smoke Bomb detonates, nearby enemies are thrown backward", gear: "Smoke Bomb, The Mist of Yagata" },
      { name: "Black Powder Bomb", description: "Add Black Powder Bombs to your Bomb Pack", gear: "Bomb Pack, Forbidden Medicine" },
      ...
      { name: "Burning Blade", description: "Melee attacks have a chance to apply the Burning effect", gear: "All Katanas" },
      ...
      { name: "Deep Bags", description: "Increased radius and number of Caltrops", gear: "Caltrops, Demon Seeds" },
      { name: "Eagle Eye", description: "Increase zoom by 200%", gear: "Longbow" },
      { name: "Fire Master", description: "Increase fire damage by 25%", gear: "All Charms" },
      { name: "Fired Up", description: "Lights targets on fire", gear: "Kunai, Spirit Kunai, Sticky Bomb, Magma Bomb, The Touch of Heaven, Dirt Throw, Lady Sanjo's Surprise, Caltrops, Demon Seeds" },
      { name: "Flash Bomb", description: "Adds Flash Bombs to the Bomb Pack", gear: "Bomb Pack, Forbidden Medicine" },
      { name: "Foul Arrows", description: "Headshots also apply Weaken to the target", gear: "Hunter Charm" },
      { name: "Hallucination Darts", description: "Arrows fired with a full draw cause knock back on hit.", gear: "Blowgun, Heaven's Sting" },
      { name: "Headshot Refund", description: "Instantly recover non-special ammon when landing a headshot from this weapon", gear: "Half Bow, Longbow,  The Weightless Spirit, Skipping Stone Bow" },
      ...
      { name: "Helmet Piercing Ammo", description: "Ammo from this weapon pierces helmets", gear: "Half Bow, Longbow, Blowgun, Heaven's Sting, The Weightless Spirit, Sugaru's Sight, Skipping Stone Bow" },
      { name: "Hidden Blades", description: "Throw 5 Kunai at once", gear: "Kunai, Spirit Kunai" },
      ...
      { name: "Increased Radius", description: "Radius increased by 50%", gear: "Sticky Bomb, Magma Bomb, The Touch of Heaven" },
      { name: "Intimidating Counter", description: "Perfect Parry counter attacks have a 50% chance to also deal damage to nearby foes", gear: "All Katanas" },
      ...
      { name: "Lucky", description: "15% chance to instantly reset cooldown on use", gear: "Kunai, Spirit Kunai, Sticky Bomb, Magma Bomb, The Touch of Heaven, Dirt Throw, Lady Sanjo's Surprise, Healing Gourd, Bottle of Liquid Courage, Kenji's Shared Brew, Caltrops, Demon Seeds, Smoke Bomb, The Mist of Yagata" },
      { name: "Moon Master", description: "Spinning Strike can combo 3 times. The final attack in the Heavy Strike combo deals increased damage.", gear: "All Katanas" },
      { name: "Moon Stance", description: "Allows switching to Moon stance", gear: "All Katanas" },
      { name: "Munitions", description: "Creates random ammo pickups on use", gear: "Smoke Bomb, The Mist of Yagata" },
      { name: "Poison Blade", description: "Melee attacks have a chance to apply the Poison effect", gear: "All Katanas" },
      { name: "Poisoned Ammo", description: "Bow attaccks have the chance to apply the Poison effect", gear: "Half Bow, Longbow, The Weightless Spirit, Sugaru's Sight, Skipping Stone Bow" },
      { name: "Rancid", description: "Applies weaken on hit", gear: "Dirt Throw, Lady Sanjo's Surprise" },
      ...
      { name: "Ronin Unlock", description: "Can be used by the Ronin", gear: "Blowgun, Heaven's Sting" },
      { name: "Samurai Unlock", description: "Can be used by the Samurai", gear: "Forbidden Medicine" },
      { name: "Scavenger", description: "Increase ammo scavenged from pickups by 100%", gear: "Hunter Charm" },
      { name: "Sharpened Ammo", description: "Ranged attaccks have the chance to apply the Bleed effect", gear: "Half Bow, Longbow, The Weightless Spirit, Sugaru's Sight, Skipping Stone Bow, Blowgun, Heaven's Sting" },
      { name: "Sharpshooter", description: "Increase zoom by 100%", gear: "Longbow" },
      { name: "Shield Piercing Ammo", description: "Ammo from this weapon pierces shields", gear: "Half Bow, Longbow, The Weightless Spirit, Sugaru's Sight, Skipping Stone Bow, Blowgun, Heaven's Sting" },
      { name: "Spirit Bear", description: "Ronin's Spirit Animal summons a bear instead of a dog", gear: "Ronin Charm" },
      { name: "Stone Master", description: "Perform Stone Stance heavy attacks with ferocious speed, and the final attack does increased damage", gear: "All Katanas" },
      { name: "Stone Stance", description: "Allows switching to Stone stance", gear: "All Katanas" },
      { name: "Strong Brew", description: "Healing increased by 50%", gear: "Healing Gourd, Bottle of Liquid Courage, Kenji's Shared Brew" },
      { name: "Sudden Resolve", description: "Fills the first Resolve on use", gear: "Healing Gourd, Kenji's Shared Brew, Smoke Bomb, The Mist of Yagata" },
      ...
      { name: "Super Massive", description: "Deals extra damage and causes lighter enemies to get thrown back when hit", gear: "Kunai, Spirit Kunai" },
      { name: "Throwing Shot", description: "Arrows fired with a full draw cause knock back on hit.", gear: "Longbow" },
      { name: "Versatile", description: "Can be used by any class", gear: "Longbow" },
      { name: "Water Master", description: "Inflict increasing damage with each attack in your Surging Strikes", gear: "All Katanas" },
      { name: "Water Stance", description: "Allows switching to Water stance", gear: "All Katanas" },
      { name: "Way of the Flame", description: "Ignite the All Katanas to apply Burning damage to melee attacks for a short time", gear: "All Katanas" },
      { name: "Wind Master", description: "Typhoon kick deals increased Stagger damage and causes knock down", gear: "All Katanas" },
      { name: "Wind Stance", description: "Allows switching to Wind stance", gear: "All Katanas" }
    ],
    samuraiTec: [
    ...
    assassinTec: [
      ...
      { slot: "Ability", name: "Toxic Vanish", description: "Vanish in a cloud of poison smoke that deals stagger damage to nearby enemies" },
