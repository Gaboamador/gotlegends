const items = {
    ...
    props: [
      ...
      { name: "Headshot Damage", value: "5%-10%", description: "Increases damage od Headshots with the bow", gear: "Half Bow, Long Bow, Ranged Charm, Hunter Charm" },
      ...
      { name: "Ranged Damage", value: "5%-12%", description: "Increases damage from Ranged weapons.", gear: "Half Bow, Long Bow, Ranged Charm, Hunter Charm" },
      { name: "Ranged Projectile Velocity", value: "15%-25%", description: "Increases speed of projectiles", gear: "Half Bow, Long Bow" },
      { name: "Ranged Resolve Gain", value: "5%-10%", description: "Increases Resolve gained from Ranged attacks and kills.", gear: "Half Bow, Long Bow, Ranged Charm, Hunter Charm" },
      { name: "Reload Speed", value: "10%-20%", description: "Increases speed of nocking an arrow after firing", gear: "Half Bow, Long Bow, Ranged Charm, Hunter Charm" },
